...
function saveSession(){
  LS.set('session_'+S.id, {history, board, revealed:[...revealed], qCount, lastTurns, student, lastSuggested, stage, openingDone:[...openingDone], boardFacts:[...boardFacts], log: $('log').innerHTML});
}
