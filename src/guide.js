...
const doc = new Document({
  ...
  sections:[{ properties:{ page:{ margin:{ top:1440, bottom:1440, left:1440, right:1440 } } }, children:[
    ...
    table([
      ...
      ['Microphone','Click to start listening, click again to stop. Words appear in the box. Students can fix them or type instead. Enter sends. The button is grey and says "Please wait..." while the narrator or a family member is speaking.'],
      ...
      ['Narrator','A different voice (for example Ryan) reads out what the back of the room cannot see: the "joined the call" message and any question that was typed instead of spoken. Choose the voice, or turn the narrator off, in Settings under Spoken voices.'],
