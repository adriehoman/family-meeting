...
},
{
  ...
  "checklist": [
    {"id": "g1", "stage": "cherry", "title": "Communicate with respect", "official": "Use communication techniques that were respectful and met the person's communication needs including:", "items": [
      {"id": "listen", "label": "Active listening", "official": "Active listening", "hint": "shows they heard Cherry: repeats back or sums up what she said, names her feeling, follows up on something she said, or gives her quiet time to speak"},
      {"id": "touch", "label": "Reassure her, and use touch the way she likes it", "official": "Appropriate reassurance and use of touch that meets the person's preferences", "hint": "gives calm reassurance AND asks before touching, or offers touch the way Cherry likes it (for example asks if she would like her hand held). A hug without asking does not count"},
    ...
    {"id": "g2", "stage": "cherry", "title": "Find out what matters to her", "official": "Through consultation and discussion with the person identify the person's social, cultural and spiritual preferences", "items": [
      {"id": "prefs", "label": "Ask about her social, cultural and spiritual life", "official": "Through consultation and discussion with the person identify the person's social, cultural and spiritual preferences", "parts": [
    ...
    {"id": "g3", "stage": "cherry", "title": "Talk with her in a way that...", "official": "Participate in a discussion with the person which:", "items": [
      ...
      {"id": "needs", "label": "Thinks about her needs, stage of life and strengths", "official": "Considers the person's individual needs, stage of life, development, strengths", "hint": "adjusts to Cherry as a person: for example offers help with the phone buttons because of her shaky hands, thinks about her walking frame or balance, speaks slowly and simply while she is upset, or links support to her age, her grief or what she can do"},
      {"id": "money", "label": "Gently checks the money worry and signs of abuse", "official": "Tactfully confirms any financial issues and indicators of abuse", "hint": "asks open, gentle questions to confirm what is happening with the ornaments or money (what she thinks happened, how many are gone, who might have taken them) without accusing Donna"},
      {"id": "unmet", "label": "Notices needs that are not being met", "official": "Recognises signs of unmet or additional needs", "hint": "notices or asks about unmet needs: no breakfast, no sleep, still in dressing gown, not going to church, needs help with the phone"},
    ...
    {"id": "g4", "stage": "cherry", "title": "Support her in a way that...", "official": "Provide support in a manner that:", "items": [
      ...
      {"id": "privacy", "label": "Keeps her dignity, privacy and confidentiality", "official": "Maintains a person's dignity, privacy and confidentiality", "hint": "protects her dignity and privacy and explains honestly who will be told and why (only the supervisor, need to know)"},
    ...
    {"id": "g5", "stage": "cherry", "title": "Give information and help", "official": "Provide information and assistance to the person in order to:", "items": [
      {"id": "services", "label": "Help her reach support services", "official": "Facilitate and access support services and resources", "parts": [
        {"id": "minister", "label": "Minister booked for tomorrow", "hint": "helps Cherry contact Reverend Hill (the Minister) and make an appointment for tomorrow"},
        {"id": "info", "label": "information about a support service", "hint": "gives or offers information or a brochure about an external support service for financial abuse, such as OPAN, and explains what it does"},
        {"id": "dial", "label": "number dialled", "hint": "before leaving, helps Cherry dial the support service's phone number"}
      ]},
      {"id": "selfmanage", "label": "Help her do what she can herself", "official": "Self-manage their own service delivery where able", "hint": "encourages Cherry to make her own calls and decisions about services, helping only where needed (for example she talks, the worker presses the buttons)"}
    ]},
    {"id": "g6", "stage": "cherry", "title": "Strengths and independence", "official": "Promote and facilitate opportunities for participation in activities that reflect the person's individual, physical, social, cultural and spiritual needs, using existing and potential new networks:", "items": [
      {"id": "strengths", "label": "Help her name her own strengths", "official": "Facilitate and encourage the person to identify own strengths, and to build on strengths to maintain independence", "hint": "asks Cherry what she is good at, enjoys, or what has helped her in hard times before (for example her singing, her faith, knowing the stories of her ornaments), and encourages her to use it. Daily self-care (showering, dressing, breakfast) belongs to selfcare, not here"},
      {"id": "selfcare", "label": "Help her see what she can still do for herself", "official": "Facilitate and encourage the person to identify self-care capacity, and to build on abilities to maintain independence", "hint": "asks about or encourages what Cherry can do for herself (shower, dress, make breakfast) and to keep doing it"},
    ...
    {"id": "g7", "stage": "cherry", "title": "Notice what is happening", "official": "Recognise situations where:", "items": [
      {"id": "physical", "label": "Her physical situation is affecting her wellbeing", "official": "The person's physical situation is impacting upon their wellbeing", "hint": "notices or names how her physical situation affects her: shaky hands (phone buttons), balance, not eaten, not slept, not dressed"},
      {"id": "variation", "label": "Her wellbeing has changed", "official": "There are variations to the person's wellbeing", "hint": "notices she is not her usual self (normally dressed by 9, usually cheerful, has stopped going to church)"},
      ...
      {"id": "abuse", "label": "There are signs of possible abuse", "official": "Indicators of possible abuse", "hint": "recognises the missing ornaments and parcels as possible financial abuse and responds (for example says it needs to be reported, gives information)"},
      {"id": "mental", "label": "There are signs of mental ill-health", "official": "Indicators of mental ill-health", "hint": "recognises low mood, grief, withdrawal, wanting to stay in bed and talk to no one, not eating or sleeping, and responds (checks how she is feeling, asks gently about her safety, plans support)"}
    ]},
