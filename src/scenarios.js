...
},
{
  ...
  "checklist": [
    {"id": "g1", "stage": "cherry", "title": "Communicate with respect", "official": "Use communication techniques that were respectful and met the person's communication needs including:", "items": [
      {"id": "listen", "label": "Active listening", "how": "both", "official": "Active listening", "hint": "shows they heard Cherry: repeats back or sums up what she said, names her feeling, follows up on something she said, or gives her quiet time to speak"},
      {"id": "touch", "label": "Reassure her, and use touch the way she likes it", "how": "both", "official": "Appropriate reassurance and use of touch that meets the person's preferences", "hint": "gives calm reassurance AND asks before touching, or offers touch the way Cherry likes it (for example asks if she would like her hand held). A hug without asking does not count"},
    ...
    {"id": "g3", "stage": "cherry", "title": "Talk with her in a way that...", "official": "Participate in a discussion with the person which:", "items": [
      ...
      {"id": "unmet", "label": "Notices needs that are not being met", "how": "both", "official": "Recognises signs of unmet or additional needs", "hint": "notices or asks about unmet needs: no breakfast, no sleep, still in dressing gown, not going to church, needs help with the phone"},
